  ...
  <el-row justify="center" style="margin-top: 100px;">
    <el-col :span="8">
      <el-card class="white-bg-card">
        ...
        <el-form :model="form" @submit.prevent="register" label-width="80px" style="width:100%;">
          ...
          <el-form-item label="确认密码" class="form-item-align">
            <el-input v-model="form.confirm" type="password" placeholder="请再次输入密码" clearable class="full-width-input" />
          </el-form-item>
          ...
          <el-form-item>
            <el-link class="glass-btn" type="primary" @click="$router.push('/user-login')">已有账号？去登录</el-link>
          </el-form-item>
